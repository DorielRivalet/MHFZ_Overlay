...
public static class AchievementsMapper
{
    ...
    public static IReadOnlyDictionary<int, Achievement> IDAchievement { get; } = new Dictionary<int, Achievement>
    {
        ...
        },
        {
            ...
            Description = string.Empty,
            Rank = AchievementRank.Platinum,
            Image = @"pack://application:,,,/MHFZ_Overlay;component/Assets/Icons/achievement/medal_stamp.png",
        ...
        },
        {
            ...
            Description = string.Empty,
            Rank = AchievementRank.Gold,
            Image = @"pack://application:,,,/MHFZ_Overlay;component/Assets/Icons/achievement/book_weapon.jpg",

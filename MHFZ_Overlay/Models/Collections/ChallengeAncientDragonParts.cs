        ...
        {
            {
                0, new List<ChallengeAncientDragonPart>
                {
                    ...
                    {
                        Description = "Imposing head, reminiscent of a true dragon's. With three distinct horns atop it, the central horn stands tall and vibrant in yellow, flanked by two shorter, white horns that curve downwards. A visor-like structure conceals any hint of visible eyes, but a fierce maw is fully exposed, exuding a sense of power.",
                        Name = "Cranium",
...
Unlock an upgrade for increasing the chance of finding an ancient dragon part's scraps.",
                    ...
                    new ChallengeAncientDragonPart
                    {
                        Description = "A testament to both strength and grace. Muscular and sinewy, these limbs are clad in the same formidable steel armor that encases its body. From shoulder to claw-tipped digits, the forelimbs exude power and purpose. Despite their bulk, they carry an undeniable agility, capable of precise movements and devastating strikes.",
                        Name = "Forelimbs",
                        ImageLink = @"pack://application:,,,/MHFZ_Overlay;component/Assets/Icons/png/unknown.png",
                    ...
                    new ChallengeAncientDragonPart
                    {
                        Description = "Providing a stable and mighty foundation, these limbs, clad in the same steel armor as the rest of its body, are capable of propelling the creature forward with incredible force. They allow for agile movement and powerful strikes, making them a crucial asset in combat.",
                        Name = "Hindlegs",
                        ImageLink = @"pack://application:,,,/MHFZ_Overlay;component/Assets/Icons/png/unknown.png",
